...
- Benchmark use: real transaction timing with controlled coarsening and
  synthetic responses; original outcomes and prices are not used as benchmark
  responses.
...
The checked-in NPZ contains only a sequential trajectory index, minute of day,
and the frozen event mark. Source customer identifiers, invoice identifiers,
calendar dates, quantities, prices, and product fields are not retained.
